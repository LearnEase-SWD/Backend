...
=======
/* 4. Courses */
INSERT INTO Courses (CourseID, CourseName, CourseDescription, Price, Language, DifficultyLevel, CreatedAt, UpdatedAt) 
VALUES ('a1b2c3d4-e5f6-7890-abcd-1234567890ab', N'Giao tiếp tiếng Anh cơ bản', N'Khóa học giúp bạn làm quen với các tình huống giao tiếp hàng ngày.', 500000, N'English', N'Beginner', '2024-01-01', NULL);

INSERT INTO Courses (CourseID, CourseName, CourseDescription, Price, Language, DifficultyLevel, CreatedAt, UpdatedAt) 
VALUES ('b2c3d4e5-f678-9012-abcd-2345678901bc', N'Tiếng Anh trung cấp', N'Khóa học giúp cải thiện khả năng giao tiếp và viết tiếng Anh.', 800000, N'English', N'Intermediate', '2024-02-11', NULL);

INSERT INTO Courses (CourseID, CourseName, CourseDescription, Price, Language, DifficultyLevel, CreatedAt, UpdatedAt) 
VALUES ('c3d4e5f6-7890-1234-abcd-3456789012cd', N'Tiếng Anh nâng cao', N'Dành cho những người muốn thành thạo tiếng Anh.', 1200000, N'English', N'Advanced', '2024-02-11', NULL);

INSERT INTO Courses (CourseID, CourseName, CourseDescription, Price, Language, DifficultyLevel, CreatedAt, UpdatedAt) 
VALUES ('d4e5f678-9012-3456-abcd-4567890123de', N'Tiếng Nhật sơ cấp', N'Bước đầu làm quen với tiếng Nhật và bảng chữ cái.', 600000, N'Japanese', N'Beginner', '2024-02-11', NULL);

INSERT INTO Courses (CourseID, CourseName, CourseDescription, Price, Language, DifficultyLevel, CreatedAt, UpdatedAt) 
VALUES ('e5f67890-1234-5678-abcd-5678901234ef', N'Tiếng Nhật trung cấp', N'Khóa học giúp bạn nâng cao kỹ năng đọc và giao tiếp tiếng Nhật.', 900000, N'Japanese', N'Intermediate', '2024-02-11', NULL);

/* 5. Flashcards */
INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000001', N'Hello', N'Xin chào', NULL, N'Chào hỏi & Giao tiếp', '2024-01-01 08:30:00');

INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000002', N'Goodbye', N'Tạm biệt', NULL, N'Chào hỏi & Giao tiếp', '2024-01-02 09:15:00');

INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000003', N'Thank you', N'Cảm ơn', NULL, N'Lịch sự & Xã giao', '2024-01-03 10:45:00');

INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000004', N'Sorry', N'Xin lỗi', NULL, N'Lịch sự & Xã giao', '2024-01-04 11:20:00');

INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000005', N'Apple', N'Táo', NULL, N'Thực phẩm & Đồ ăn', '2024-01-05 13:10:00');
>>>>>>> 0ecdd4bbafeacfb7d53fb2968565f814a0d34acc

INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000006', N'Car', N'Xe hơi', NULL, N'Phương tiện & Giao thông', '2024-01-06 14:25:00');

INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000007', N'Dog', N'Chó', NULL, N'Động vật & Thiên nhiên', '2024-01-07 15:00:00');

INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000008', N'Computer', N'Máy tính', NULL, N'Công nghệ & Khoa học', '2024-01-08 16:45:00');

INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000009', N'Book', N'Sách', NULL, N'Giáo dục & Học tập', '2024-01-09 17:30:00');

INSERT INTO Flashcards (FlashcardID, LessonID, Front, Back, PronunciationAudioURL, Topic, CreatedAt) 
VALUES ('00000000-0000-0000-0000-000000000010', N'Music', N'Âm nhạc', NULL, N'Giải trí & Nghệ thuật', '2024-01-10 18:20:00');
...
INSERT INTO Lessons (LessonID, CourseID, [Index], Title, LessonType, CreatedAt) 
VALUES ('2b3c4d5e-f6e7-4901-bcde-2345678901ac', 'a1b2c3d4-e5f6-7890-abcd-1234567890ab', 2, N'Mẫu câu giao tiếp hàng ngày', N'Lý thuyết', '2024-02-02');

INSERT INTO Lessons (LessonID, CourseID, [Index], Title, LessonType, CreatedAt) 
VALUES ('3c4d5e6f-f789-4123-bcde-3456789012ad', 'b2c3d4e5-f678-9012-abcd-2345678901bc', 1, N'Ngữ pháp cơ bản', N'Lý thuyết', '2024-02-03');

INSERT INTO Lessons (LessonID, CourseID, [Index], Title, LessonType, CreatedAt) 
VALUES ('4d5e6f70-8901-4345-bcde-4567890123ae', 'b2c3d4e5-f678-9012-abcd-2345678901bc', 2, N'Luyện nói: Mô tả bản thân', N'Hội thoại', '2024-02-04');

INSERT INTO Lessons (LessonID, CourseID, [Index], Title, LessonType, CreatedAt) 
VALUES ('5e6f7890-0123-4567-bcde-5678901234af', 'c3d4e5f6-7890-1234-abcd-3456789012cd', 1, N'Thảo luận nâng cao', N'Hội thoại', '2024-02-05');

INSERT INTO Lessons (LessonID, CourseID, [Index], Title, LessonType, CreatedAt) 
VALUES ('6f789012-2345-4789-bcde-6789012345b0', 'c3d4e5f6-7890-1234-abcd-3456789012cd', 2, N'Viết luận chuyên sâu', N'Bài tập', '2024-02-06');
...
INSERT INTO Lessons (LessonID, CourseID, [Index], Title, LessonType, CreatedAt) 
VALUES ('8b901234-4567-4123-bcde-8901234567b2', 'd4e5f678-9012-3456-abcd-4567890123de', 2, N'Phát âm Hiragana và Katakana', N'Lý thuyết', '2024-02-08');

INSERT INTO Lessons (LessonID, CourseID, [Index], Title, LessonType, CreatedAt) 
VALUES ('9c012345-5678-4345-bcde-9012345678b3', 'e5f67890-1234-5678-abcd-5678901234ef', 1, N'Đọc hiểu đoạn văn', N'Bài tập', '2024-02-09');

INSERT INTO Lessons (LessonID, CourseID, [Index], Title, LessonType, CreatedAt) 
VALUES ('0d123456-6789-4567-bcde-0123456789b4', 'e5f67890-1234-5678-abcd-5678901234ef', 2, N'Luyện nghe hội thoại', N'Hội thoại', '2024-02-10');
...
INSERT INTO UserRoles (UserId, RoleId) VALUES ('user-3', 'role-2'); 
INSERT INTO UserRoles (UserId, RoleId) VALUES ('user-4', 'role-2'); 
INSERT INTO UserRoles (UserId, RoleId) VALUES ('user-5', 'role-2'); 
INSERT INTO UserRoles (UserId, RoleId) VALUES ('user-6', 'role-2'); 
INSERT INTO UserRoles (UserId, RoleId) VALUES ('user-7', 'role-2'); 
INSERT INTO UserRoles (UserId, RoleId) VALUES ('user-8', 'role-2'); 
INSERT INTO UserRoles (UserId, RoleId) VALUES ('user-9', 'role-2'); 
INSERT INTO UserRoles (UserId, RoleId) VALUES ('user-10', 'role-2'); 
